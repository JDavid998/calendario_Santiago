...
// Mostrar modal de gesti�n de calendarios
...
async function deleteWorkspace(id) {
    if (!confirm('�Est�s seguro de que quieres eliminar este calendario? Todos los datos asociados se perder�n.')) {
        return;
    }
